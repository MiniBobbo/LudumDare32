...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/data/nouns/arguments.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/data/nouns/debateSubject.txt", "assets/data/nouns/debateSubject.txt");
			type.set ("assets/data/nouns/debateSubject.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/data/nouns/nouns.txt", "assets/data/nouns/nouns.txt");
			type.set ("assets/data/nouns/nouns.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/data/nouns/rebuttals.txt", "assets/data/nouns/rebuttals.txt");
			type.set ("assets/data/nouns/rebuttals.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			type.set ("assets/images/Aristotle.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/hal9000.png", Reflect.field (AssetType, "image".toUpperCase ()));
